...
% Last Modified by GUIDE v2.5 13-Jan-2018 19:26:27
...
function FE_ed_custom_mf_Callback(hObject, eventdata, handles)
% Update frequency values
handles = FE_update_frequency_bands(handles, hObject);
guidata(hObject, handles);
...
% --- Executes during object creation, after setting all properties.
function FE_ed_custom_mf_CreateFcn(hObject, eventdata, handles)
% hObject    handle to FE_ed_custom_mf (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function FE_ed_custom_maf_Callback(hObject, eventdata, handles)
% Update frequency values
handles = FE_update_frequency_bands(handles, hObject);
guidata(hObject, handles);

% --- Executes during object creation, after setting all properties.
function FE_ed_custom_maf_CreateFcn(hObject, eventdata, handles)
% hObject    handle to FE_ed_custom_maf (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function FE_pb_ok_CreateFcn(hObject, eventdata, handles)
% hObject    handle to FE_pb_ok (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
