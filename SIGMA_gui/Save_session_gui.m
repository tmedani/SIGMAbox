...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%$ TODO : ask the User to use the defaut output file or not with dialgbox
[FileName,PathName] = uiputfile();
if FileName==0
    display('Save session is not saved')
    msgbox('Save session is aborded','SIGMA info','warning');
    return
else
