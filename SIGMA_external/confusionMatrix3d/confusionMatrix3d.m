function [confusion_matrix, overall_pcc, group_stats, groups_list] = confusionMatrix3d(predicted_groups,actual_groups,plot_title,plot_ok)
% confusionMatrix3d,
...
%         if nargin==3
%             title('Observations by Predicted and Actual Groups','fontsize',14);
%         end
        %if nargin==4
