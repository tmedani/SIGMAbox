...
% 
if isempty(init_parameter.subject)
    init_parameter.nb_channels=nan;
    init_parameter.sampling_rate=nan;
    init_parameter.sampling_rate_by_data=nan;
    init_parameter.channel_name=nan;
    return
end
